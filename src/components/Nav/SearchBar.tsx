...
const SearchBar = () => {
  ...
  return (
    <div className="relative">
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className="absolute -bottom-24 lg:bottom-0 xl:top-0 left-28 sm:left-full transform -translate-x-full flex items-center space-x-2 bg-white rounded-lg shadow px-4 py-2 w-80">
  ...
  "
      ...
      >
        <div
          ref={filterRef}
          className="absolute right-2 md:right-28 top-32 lg:-left-14 mt-4 bg-white shadow-lg rounded-lg p-4 w-80"
        >
          {/* Gender Filter */}
          <div className="mb-4">
            <button
